...
class FCDenseNet(nn.Module):
    def __init__(self, in_channels, out_channels, down_blocks=(4, 4, 4, 4, 4),
        ...
        for i in range(len(down_blocks)):
            self.denseBlocksDown.append(
                DenseBlock(in_channels=cur_channels_count, growth_rate=growth_rate, n_layers=down_blocks[i]))
...
"""
@history
__version__ = "1.0.1" -> removed final softmax 
